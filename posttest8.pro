...
domains
  person = p(nama, umur, telno, kerja,jabatan,keluarga,jodoh )  /* variabel ada di dalam tanda kurung*/
  umur = integer /* tipe data umur berupa angka */
  telno, nama, kerja, jabatan, keluarga,jodoh = string /* tipe data berupa string */
